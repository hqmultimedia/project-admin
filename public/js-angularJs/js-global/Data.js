upload.controller('Load_Data_Controller', function($rootScope, $scope, $http, $location, $cookies, $routeParams) {
        ...
        $rootScope.getDataPagination = function(page_data, page_function, option_value) {
                ...
                if (page_data == 'posts') {
                    ...
                    var URL_API_Load = 'https://hqmultimedia.github.io/project-admin/Data/posts.json';

                    // dữ liệu offline
                    // var URL_API_Load = 'https://hqmultimedia.github.io/project-admin/Data/order.json';
                }
                if (page_data == 'order' || option_value == 'all') {
                    ...
                    var URL_API_Load = 'https://hqmultimedia.github.io/project-admin/Data/donhang.json';
                    if (option_value == 'processed') {
                        var URL_API_Load = 'https://hqmultimedia.github.io/project-admin/Data/donhang-processed.json';

                    }
                    if (option_value == 'no_processed') {
                        var URL_API_Load = 'https://hqmultimedia.github.io/project-admin/Data/donhang-no-processed.json';

                    }
                    if (option_value == 'transport') {
                        var URL_API_Load = 'https://hqmultimedia.github.io/project-admin/Data/donhang-transport.json';

                    }
                    if (option_value == 'complete') {
                        var URL_API_Load = 'https://hqmultimedia.github.io/project-admin/Data/donhang-complete.json';

                    }
                }
                if (page_data == 'preview_order') {
                    // var URL_API_Load = 'http://localhost/Angular2026/admin/CrudDataController/get_data_box_trash';
                    var URL_API_Load = 'https://hqmultimedia.github.io/project-admin/Data/chitiet-donhang.json';
                }
                if (page_data == 'product') {
                    // var URL_API_Load = 'http://localhost/Angular2026/admin/CrudDataController/get_data_box_trash';
                    var URL_API_Load = 'https://hqmultimedia.github.io/project-admin/Data/product.json';
                }
                if (page_data == 'category') {
                    // var URL_API_Load = 'http://localhost/Angular2026/admin/CrudDataController/get_data_box_trash';
                    var URL_API_Load = 'https://hqmultimedia.github.io/project-admin/Data/category.json';
                }
                if (page_data == 'comment') {
                    // var URL_API_Load = 'http://localhost/Angular2026/admin/CrudDataController/get_data_box_trash';
                    var URL_API_Load = 'https://hqmultimedia.github.io/project-admin/Data/comment.json';
                }
                if (page_data == 'client') {
                    // var URL_API_Load = 'http://localhost/Angular2026/admin/CrudDataController/get_data_box_trash';
                    var URL_API_Load = 'https://hqmultimedia.github.io/project-admin/Data/client.json';
                }
                if (page_data == 'assess') {
                    // var URL_API_Load = 'http://localhost/Angular2026/admin/CrudDataController/get_data_box_trash';
                    var URL_API_Load = 'https://hqmultimedia.github.io/project-admin/Data/assess.json';
                }
                if (page_data == 'baner') {
                    // var URL_API_Load = 'http://localhost/Angular2026/admin/CrudDataController/get_data_box_trash';
                    var URL_API_Load = 'https://hqmultimedia.github.io/project-admin/Data/baner.json';
                }
        ...
        $rootScope.getDataBoxTrash = function(page_data, page_function) {
                ...
                if (page_data == 'posts') {
                    // var URL_API_Load = 'http://localhost/Angular2026/admin/CrudDataController/get_data_box_trash';
                    var URL_API_Load = 'https://hqmultimedia.github.io/project-admin/Data/data-trash.json';
                }
                if (page_data == 'product') {
                    // var URL_API_Load = 'http://localhost/Angular2026/admin/CrudDataController/get_data_box_trash';
                    var URL_API_Load = 'https://hqmultimedia.github.io/project-admin/Data/data-trash-product.json';
                }
                if (page_data == 'category') {
                    // var URL_API_Load = 'http://localhost/Angular2026/admin/CrudDataController/get_data_box_trash';
                    var URL_API_Load = 'https://hqmultimedia.github.io/project-admin/Data/data-trash-category.json';
                }
                if (page_data == 'baner') {
                    // var URL_API_Load = 'http://localhost/Angular2026/admin/CrudDataController/get_data_box_trash';
                    var URL_API_Load = 'https://hqmultimedia.github.io/project-admin/Data/data-trash-baner.json';
                }
        ...
        $rootScope.LocationBaner = function() {
                ...
                var URL_API_Load = 'https://hqmultimedia.github.io/project-admin/Data/location_baner.json';
